...
public class horiVisitingAdapter extends RecyclerView.Adapter<horiVisitingAdapter.myViewHolder> {

    Context mContext;

    public horiVisitingAdapter(Context mContext) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.horizontal_visiting_row, parent, false);
        return new horiVisitingAdapter.myViewHolder(listItem);
    }

    @Override
    public void onBindViewHolder(@NonNull horiVisitingAdapter.myViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Constant.setSF.putString("veriHoriKey", "HORI");
