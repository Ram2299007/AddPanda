...
import com.Appzia.addpanda.databinding.ActivityTermAndConditionScreenBinding;
...
public class termAndConditionScreen extends AppCompatActivity {

    ActivityTermAndConditionScreenBinding binding;
    ...
    public void onStart() {
        ...
        if ((Constant.wifiInfo != null && Constant.wifiInfo.isConnected()) || (Constant.mobileInfo != null && Constant.mobileInfo.isConnected())) {
            ...
            Webservice.get_term_and_condition(mContext, token);
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTermAndConditionScreenBinding.inflate(getLayoutInflater());
