...
import com.Appzia.addpanda.databinding.ActivityViewAllBasicBinding;
...
public class viewAllBasic extends AppCompatActivity {

    ActivityViewAllBasicBinding binding;

    String catId;
    public static Context mContext;
    public static RecyclerView recyclerView;
    String token;
    public static viewAllAdapterBasic adapter;
    ...
    protected void onStart() {
        ...
        try {
            ...
            if ((Constant.wifiInfo != null && Constant.wifiInfo.isConnected()) || (Constant.mobileInfo != null && Constant.mobileInfo.isConnected())) {
                Webservice.get_sub_category_list_Basic(mContext, catId, token, viewAllBasic.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= ActivityViewAllBasicBinding.inflate(getLayoutInflater());
    ...
    public static void setAdapter() {
        ...
        adapter = new viewAllAdapterBasic(mContext);
        recyclerView.setAdapter(adapter);


    }

//    public static void setAdapterAni() {
//
//
//        layoutManager2 = new GridLayoutManager(mContext, 3);
//        recyclerView.setLayoutManager(layoutManager2);
//        adapter2 = new viewAllAniAdapter(mContext);
