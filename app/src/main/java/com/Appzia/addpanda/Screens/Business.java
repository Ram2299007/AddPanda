...
public class Business extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.dateofincorp.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.Q)
            @Override
            public void onClick(View view) {

                DatePickerDialog datePickerDialog = new DatePickerDialog(Business.this, android.R.style.Theme_Holo_Dialog_MinWidth
        ...
        setListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int years, int months, int dayofMonths) {
                ...
                if (String.valueOf(months).length() == 1 && String.valueOf(dayofMonths).length() == 1) {
                    ...
                    binding.dateofincorp.setText(date);
                        ...
                        if (progress == 100) {
                            ...
                            if (binding.name.getText().toString().isEmpty() || binding.email.getText().toString().isEmpty() || binding.mobilePersonal.getText().toString().isEmpty() || binding.web.getText().toString().isEmpty() || binding.address.getText().toString().isEmpty() || binding.category.getText().toString().isEmpty() || binding.dateofincorp.getText().toString().isEmpty() || binding.businessd.getText().toString().isEmpty()) {
                                ...
                                if (social_media_type.equals("1")) {    //for google
                                    ...
                                    Constant.NetworkCheck(mContext);
                                    if ((Constant.wifiInfo != null && Constant.wifiInfo.isConnected()) || (Constant.mobileInfo != null && Constant.mobileInfo.isConnected())) {
                                        Webservice.update_user_profile_data_business(mContext, account_type, binding.name.getText().toString(), binding.email.getText().toString(), binding.mobilePersonal.getText().toString(), binding.address.getText().toString(), binding.web.getText().toString(), binding.category.getText().toString(), binding.dateofincorp.getText().toString(), binding.businessd.getText().toString(), token);
