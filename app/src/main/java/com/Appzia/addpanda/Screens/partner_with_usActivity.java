...
public class partner_with_usActivity extends AppCompatActivity {

    ActivityPartnerWithUsBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityPartnerWithUsBinding.inflate(getLayoutInflater());
        ...
        binding.contact1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),contactCreatorScreen.class);
        ...
        binding.contact2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),contactCreatorScreen.class);
                intent.putExtra("contact",value2);
                startActivity(intent);
            }
        });
    }
