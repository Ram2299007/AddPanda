...
import com.Appzia.addpanda.databinding.ActivityCreateVisingCardHorizontalScreensBinding;
...
public class createVisingCardHorizontalScreens extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        if ((Constant.wifiInfo != null && Constant.wifiInfo.isConnected()) || (Constant.mobileInfo != null && Constant.mobileInfo.isConnected())) {
            Webservice.get_visiting_card_list(mContext,token, createVisingCardHorizontalScreens.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCreateVisingCardHorizontalScreensBinding.inflate(getLayoutInflater());
        ...
        binding.verticalView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), createVisingCardVerticalScreens.class));
    ...
    public void setAdapter() {
        ...
        binding.horizontalVisitingRec.setLayoutManager(linearLayoutManager);
        adapter = new horiVisitingAdapter(mContext);
        binding.horizontalVisitingRec.setHasFixedSize(true);
        binding.horizontalVisitingRec.setAdapter(adapter);
